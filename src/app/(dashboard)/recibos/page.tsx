  ...
  async function buildReceiptPreviewEl(data: any, settings: any) {
    ...
    el.innerHTML = `
      ...
      <div style="border-top:1px solid #E8E0D8;padding-top:16px;display:flex;justify-content:space-between;align-items:flex-end;">
        ...
        <div style="text-align:right;">
          ${settings?.signature_url ? `<img src="${settings.signature_url}" alt="Firma" style="height:48px;margin-left:auto;" />` : `<p style="font-size:14px;font-style:italic;color:#5C3E35;font-weight:300;margin:0;font-family:Georgia,serif;">${esc(settings?.business_name) || "ALMAIA"}</p>`}
