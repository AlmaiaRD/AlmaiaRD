  ...
  async function buildPreviewEl(data: any, settings: any) {
    ...
    el.innerHTML = `
      ...
      <div style="border-top:1px solid #E8E0D8;padding-top:16px;display:flex;justify-content:space-between;align-items:flex-end;">
        ...
        <div style="text-align:right;">
          ${settings?.signature_url ? `<img src="${settings.signature_url}" alt="Firma" style="height:54px;margin-left:auto;" />` : `<p style="font-size:16px;font-style:italic;color:#5C3E35;font-weight:300;margin:0;font-family:Georgia,serif;">${esc(settings?.business_name) || "ALMAIA"}</p>`}
              ...
              <div className="border-t border-[#E8E0D8] pt-4 flex justify-between items-end">
                ...
                <div className="text-right">
                  {settings?.signature_url ? (
                    <img src={settings.signature_url} alt="Firma" className="ml-auto" style={{ height: 54 }} />
                  ) : (
